        ...
        <Grid2 container spacing={10} mt={2}>
          <Grid2 item size={{ xs: 12, md: 6 }}>
            ...
            <Typography
              ...
              sx={{ mt: 2 }}
            >
              I am a passionate developer with expertise in React JS,
              JavaScript, HTML, CSS, and Material UI. My skill set extends
              beyond front-end development to include graphic design, showcasing
